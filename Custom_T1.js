...
var getPublicationMultiplier = (tau) => (game.sigmaTotal / 20) * (tau.pow(0.1));	// Original: tau.pow(0.164) / BigNumber.THREE
var getPublicationMultiplierFormula = (symbol) => "\\left(\\frac{{\\sigma_{t}}}{20}\\right)" + symbol + "}^{0.1}";	// Original: "\\frac{{" + symbol + "}^{0.15}}{2}";
