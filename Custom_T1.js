...
var init = () => {
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(5, currency, new ExponentialCost(1e8, 6 * Math.log2(10)));	// Original: (1e10, 8 * Math.log2(10))
	...
	// c5
	{
		...
		c5 = theory.createUpgrade(6, currency, new ExponentialCost(1e12, 9 * Math.log2(10)));
