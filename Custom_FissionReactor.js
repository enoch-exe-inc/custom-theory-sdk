...
var init = () => {
	currency1 = theory.createCurrency("U","\\mathrm{U}");
	currency2 = theory.createCurrency("Np","\\mathrm{Np}");
	currency3 = theory.createCurrency("Pu","\\mathrm{Pu}");
	currency4 = theory.createCurrency("Am","\\mathrm{Am}");
	currency5 = theory.createCurrency("Cm","\\mathrm{Cm}");
	currency6 = theory.createCurrency("Bk","\\mathrm{Bk}");
	currency7 = theory.createCurrency("Cf","\\mathrm{Cf}");
	currency8 = theory.createCurrency("Es","\\mathrm{Es}");
	...
	{
		URU = theory.createPermanentUpgrade(3, currency1, new LinearCost(1e6, 0));
		URU.maxLevel = 1;
	...
	{
		NpRU = theory.createPermanentUpgrade(4, currency2, new LinearCost(1e5, 0));
		NpRU.maxLevel = 1;
	...
	{
		PuRU = theory.createPermanentUpgrade(5, currency3, new LinearCost(2e5, 0));
		PuRU.maxLevel = 1;
	...
	{
		AmRU = theory.createPermanentUpgrade(6, currency4, new LinearCost(4e5, 0));
		AmRU.maxLevel = 1;
	...
	{
		CmRU = theory.createPermanentUpgrade(7, currency5, new LinearCost(4e5, 0));
		CmRU.maxLevel = 1;
	...
	{
		BkRU = theory.createPermanentUpgrade(8, currency6, new LinearCost(2e5, 0));
		BkRU.maxLevel = 1;
	...
	{
		CfRU = theory.createPermanentUpgrade(9, currency7, new LinearCost(3e6, 0));
		CfRU.maxLevel = 1;
