...
let getbuip = () => buipb + (0.033 * superL.level);	// Original: buipb + (0.01 * superL.level); - gives only a 0.91% boost to sugar lump's 10% boost. This gives it a 3% boost.
...
var init = () => {
	...
	superL.info = "Change $1.1$ in $L[i]$ to $1.133$";
