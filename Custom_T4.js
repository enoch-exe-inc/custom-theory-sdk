...
var init = () => {
	...
	// c3
	{
		...
		c3 = theory.createUpgrade(2, currency, new ExponentialCost(2000, Math.log2(2.44)));		// Original: (2000, Math.log2(2.468));
	...
	// c5
	{
		...
		c5 = theory.createUpgrade(4, currency, new ExponentialCost(1e8, Math.log2(12.3)));		// Original: (1e8, Math.log2(12.5));
	...
	// c6
	{
		...
		c6 = theory.createUpgrade(5, currency, new ExponentialCost(1e10, Math.log2(55)));		// Original: (1e10, Math.log2(58));
